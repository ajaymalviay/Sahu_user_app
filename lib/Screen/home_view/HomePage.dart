...
class _HomePageState extends State<HomePage>
  ...
  GetLeadStatusModel?getLeadStatus;
  Future<void> getStatus() async {

    var headers = {
      'Cookie': 'ci_session=85dc808070002f22be4d6aceec73de5a280d52d6'
    };
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}get_lead_status'));
    ...
    if (response.statusCode == 200) {
      ...
      final finalResponse = GetLeadStatusModel.fromJson(json.decode(Response));
      setState(() {
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 10,),
                                        Text("Mobile Number :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("Email id :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color:colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("Bank Name :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color:colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("Total Amount :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("Pick Address :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("Drop Address :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("Distance :", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: colors.blackTemp),),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 10,),
                                        Text("${getLeadData?.data?[index].bankname}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color:colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        Text("${getLeadData?.data?[index].amount}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: colors.blackTemp),),
                                        SizedBox(height: 10,),
                                        address3!=null ?Text("${address3}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: colors.blackTemp),):Text('Address not found'),
                                        SizedBox(height: 10,),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          getLeadStatus?.data==null?Center(child: CircularProgressIndicator()):Text("${getLeadStatus?.data?.total}", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.fontColor),),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          getLeadStatus?.data==null?Center(child: CircularProgressIndicator()):Text("${getLeadStatus?.data?.pending}", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.fontColor),),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          getLeadStatus?.data==null?Center(child: CircularProgressIndicator()):Text("${getLeadStatus?.data?.completed}", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.fontColor),),
